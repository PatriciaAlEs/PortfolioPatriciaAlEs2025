      ...
      <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-8 md:px-12 lg:px-20 xl:px-32">
        <div className="flex flex-col sm:flex-row justify-center items-center sm:items-start gap-8 sm:gap-10 md:gap-16 lg:gap-24 mb-8 sm:mb-10">
          ...
          <div className="flex flex-col items-center sm:items-start space-y-3 sm:space-y-4">
            <h3 className="text-xl sm:text-2xl md:text-3xl font-black text-white text-center sm:text-left" style={{ fontFamily: "'Playfair Display', serif" }}>
          ...
          <div className="flex flex-col items-center sm:items-start">
            ...
            <div className="flex gap-3 sm:gap-4 md:gap-5">
              <button
                ...
                className="bg-white/10 hover:bg-pink-light text-white hover:text-ink w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-110 hover:shadow-lg hover:shadow-pink-light/50 group cursor-pointer border-none"
                title="Copiar email"
              >
              ...
              <a
                ...
                className="bg-white/10 hover:bg-pink-light text-white hover:text-ink w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-110 hover:shadow-lg hover:shadow-pink-light/50"
                title="GitHub"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 sm:h-6 sm:w-6 md:h-7 md:w-7" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="h-px bg-gradient-to-r from-transparent via-pink-light/30 to-transparent mb-6 sm:mb-8"></div>
